...
print (f"Función de tranferencia del controlador I: {PID}")
...
plt.plot(t,PAu1,'--',color = clr3,label='Vs(t)') #Respuesta en lazo abierto
plt.plot(t,PIDu1,':', linewidth=3,color = clr4,label='I(t)') #Respuesta en lazo abierto
...
plt.plot(t,PAu2,'--',color = clr3,label='Vs(t)') #Respuesta en lazo abierto
plt.plot(t,PIDu2,':',linewidth=3,color = clr4,label='I(t)') #Respuesta en lazo abierto
plt.xlim(0,10); plt.xticks (np.arange (0,11,1))
plt.ylim(0,1.); plt.yticks (np.arange (0,1.2,0.1))
plt.xlabel('t[s]', fontsize=11)
plt.ylabel('Vi(t) [V]',fontsize=11)
...
plt.plot(t,PAu3,'--',color = clr3,label='Vs(t)') #Respuesta en lazo abierto
plt.plot(t,PIDu3,':',linewidth=3,color = clr4,label='I(t)') #Respuesta en lazo abierto
plt.xlim(0,10); plt.xticks (np.arange (0,11,1))
plt.ylim(0,1.); plt.yticks (np.arange (0,1.2,0.1))
plt.xlabel('t[s]', fontsize=11)
plt.ylabel('Vi(t) [V]',fontsize=11)
...
plt.plot(t,PAu4,'--',color = clr3,label='Vs(t)') #Respuesta en lazo abierto
plt.plot(t,PIDu4,':',linewidth=3,color = clr4,label='I(t)') #Respuesta en lazo abierto
plt.xlim(0,10); plt.xticks (np.arange (0,11,1))
